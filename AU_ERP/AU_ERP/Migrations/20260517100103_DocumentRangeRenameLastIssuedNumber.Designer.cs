...
namespace AU_ERP.Migrations
{
    ...
    [Migration("20260517100103_DocumentRangeRenameLastIssuedNumber")]
    partial class DocumentRangeRenameLastIssuedNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AU_ERP.Models.DeliveryChallan", b =>
                {
                    ...
                    b.Property<string>("DeliveryCompletedByUserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AU_ERP.Models.Driver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AU_ERP.Models.GoodReceiptDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GoodReceiptDocuments");
                });

            modelBuilder.Entity("AU_ERP.Models.GoodsIssueDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GoodsIssueDocuments");
                });

            modelBuilder.Entity("AU_ERP.Models.GoodsIssueDocumentLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FertMaterialDescription")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("FertMaterialNumber")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("GoodsIssueDocumentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GoodsIssueDocumentId");
            ...
            modelBuilder.Entity("AU_ERP.Models.ProductionOrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AU_ERP.Models.StockMovement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AU_ERP.Models.Vehicle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AU_ERP.Models.DeliveryChallan", b =>
                {
                    b.HasOne("AU_ERP.Models.Driver", "Driver")
                        .WithMany()
                    ...
                    b.HasOne("AU_ERP.Models.Vehicle", "Vehicle")
                        .WithMany()
            ...
            modelBuilder.Entity("AU_ERP.Models.GoodsIssueDocumentLine", b =>
                {
                    b.HasOne("AU_ERP.Models.CreateMaterialMaster", "FertMaterial")
                        .WithMany()
                        .HasForeignKey("FertMaterialNumber")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AU_ERP.Models.GoodsIssueDocument", "GoodsIssueDocument")
                        .WithMany("Lines")
                        .HasForeignKey("GoodsIssueDocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("AU_ERP.Models.ProductionOrderLine", "ProductionOrderLine")
                        .WithMany()
            ...
            modelBuilder.Entity("AU_ERP.Models.StockMovement", b =>
                {
                    b.HasOne("AU_ERP.Models.PlantsSample", "FromPlant")
                        .WithMany()
                    ...
                    b.HasOne("AU_ERP.Models.PlantsSample", "ToPlant")
                        .WithMany()
